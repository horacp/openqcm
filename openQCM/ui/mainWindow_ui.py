...
class Ui_Plots(object): 
    ...
    def retranslateUi(self, MainWindow2):
        ...
        MainWindow2.setWindowTitle(_translate("MainWindow2", "FZU QCM TEST SW - Real-Time Plot GUI 2.1"))
...
class Ui_Info(object):
    def setupUi(self, MainWindow3):
        ...
        self.gridLayout_2.addWidget(self.info1, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info1a, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info11, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info2, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info6, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info3, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info4, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info4a, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info5, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.info7, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.inforef, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.inforef1, row, 0, 1, 1)
        # Ref. Dissipation -----------------------------------------------------------------------
        row += 1
        ...
        self.gridLayout_2.addWidget(self.inforef2, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.l8, row, 0, 1, 1) 
        row += 1
        ...
        self.gridLayout_2.addWidget(self.l7, row, 0, 1, 1) 
        row += 1
        ...
        self.gridLayout_2.addWidget(self.l6, row, 0, 1, 1) 
        row += 1
        ...
        self.gridLayout_2.addWidget(self.l6a, row, 0, 1, 1)
        row += 1
     
        # Info about QCM Sensor Firmware --------------------------------------------------------
        self.lfw = QtWidgets.QLabel()
        self.lfw.setStyleSheet('background: #008EC0; padding: 1px;')
        self.lfw.setText("<font color=#ffffff > Info about QCM Sensor Firmware </font>")
        self.lfw.setFixedHeight(15)                
        #self.lfw.setFixedWidth(250)
        self.gridLayout_2.addWidget(self.lfw, row, 0, 1, 1) 
        row += 1
        
        # Wait before analog read [µsec] --------------------------------------------------------
        self.lfww = QtWidgets.QLabel()
        self.lfww.setStyleSheet('background: white; padding: 1px; border: 1px solid #cccccc')
        self.lfww.setText("<font color=#0000ff >  Wait before analog read [µsec] </font>")
        #self.lfww.setFixedWidth(250)                
        self.gridLayout_2.addWidget(self.lfww, row, 0, 1, 1)
        row += 1
     
        # Average samples for analog read -------------------------------------------------------
        self.lfws = QtWidgets.QLabel()
        self.lfws.setStyleSheet('background: white; padding: 1px; border: 1px solid #cccccc')
        self.lfws.setText("<font color=#0000ff >  Average samples for analog read </font>")
        #self.lfws.setFixedWidth(250)                
        self.gridLayout_2.addWidget(self.lfws, row, 0, 1, 1)
        row += 1
        ...
        self.gridLayout_2.addWidget(self.lweb, row, 0, 1, 1) 
        row += 1
        ...
        self.gridLayout_2.addWidget(self.lweb2, row, 0, 1, 1)   
        row += 1
        ...
        self.gridLayout_2.addWidget(self.lweb3, row, 0, 1, 1) 
        row += 1
        ...
        self.gridLayout_2.addWidget(self.pButton_Download, row, 0, 1, 1, QtCore.Qt.AlignRight)
        row += 1
        ##########################################################################################
